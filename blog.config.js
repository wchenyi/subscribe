...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚 >_< 一个搞砸了很多事情的人 一个烦恼比较多，兴趣比较大，比较懒的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wangcy.tk', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'progress@1116@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/@W80410098', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https:github.com/wchenyi', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'wchenyi/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'wall', // 你的Github仓库名，例如 'NotionNext'
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'wchenyi', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'wchenyi', // 管理员用户名、一般是自己 e.g 'tangly1024'
  COMMENT_GITALK_CLIENT_ID: process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_ID || '5921d634653ea00a5436', // e.g 20位ID ， 在gitalk后台获取
  COMMENT_GITALK_CLIENT_SECRET: process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_SECRET || 'ff10babd5f88e65a0cecb6ef848d2e6c92cf52c2', // e.g 40位ID， 在gitalk后台获取
  ...
  NOTION_PROPERTY_NAME: {
    password: process.env.NEXT_PUBLIC_NOTION_PROPERTY_PASSWORD || 'password', //文章设置密码，默认123456
    ...
    slug: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SLUG || 'slug', //文章标题指向输入的链接
